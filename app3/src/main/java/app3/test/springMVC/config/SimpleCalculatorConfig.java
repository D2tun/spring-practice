...
@Configuration
@ComponentScan("app3.test.springMVC.controller")
@EnableWebMvc
public class SimpleCalculatorConfig implements WebMvcConfigurer {
	
	private final ApplicationContext appContext;

	public SimpleCalculatorConfig (ApplicationContext appContext) {
